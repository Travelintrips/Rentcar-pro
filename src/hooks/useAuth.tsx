...
// Define the hook as a named export for Fast Refresh compatibility
export function useAuth() {
  ...
  return { isAuthenticated, userRole, userId, userEmail, isLoading, signOut };
}

// Export the hook directly instead of re-exporting
// This ensures Fast Refresh compatibility
